...
PY_SIMPLE_CHAT_INSTRUCTION = "You are an AI that only responds with python code, NOT ENGLISH. You will be given a description from the top competition dataset by the user which contains description of problem, input format, output format, sample input and output. Write your full implementation (do not add if __name__ == '__main__': in the code)."
...
PY_REFLEXION_CHAT_INSTRUCTION = "You are an AI Python assistant. You will be given your past implementation, a series of unit tests, and a hint to change the implementation appropriately. Write your full implementation (do not add if __name__ == '__main__': in the code)."
